...
<!-- 메인메뉴 S -->
    <div id="wrap_tmall_content">
     ...
     <ul class="top_title_area">
       <li class="top_title">환경설정 > 다국어관리</li>
      ...
      <dl>
	   ...
	   <div class="midle_bu_area ml20">
		  <ul class="left_bu_area">
			...
			<li><button type="button" style="width:80px;height:25px;margin:0 4px; font-size:13px;line-height:26px; font-weight:bold; color:white;background-color:#3f3f3f">저장</button></li>
		</ul>
		 </div>
              ...
              <div class="gridTable_list01">
                <table width="100%" border="0" >
                  ...
                  <tbody>
                    <tr>
                      <td>1</td>
                      <td>input_etc_content</td>
                      <td class="pl20">기타내용을 입력해주세요</td>
					  <td>请您输入其他内容。</td>
					  <td></td>
                    </tr>
