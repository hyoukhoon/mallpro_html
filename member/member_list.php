...
<!-- 메인메뉴 S -->
    <div id="wrap_tmall_content">
     ...
     <ul class="top_title_area">
       <li class="top_title">회원관리 > 일반회원</li>
     </ul>
...
<input type="hidden" name="sq" id="sq"  value="<?=$sq?>">
   	       ...
   	       <table>
						   ...
						   <tr>
                             ...
                             <tr>
                               <td scope="col" class="title1">가입일자</td>
                               <td>
...
<?
	$que3="select count(1) from buyer where STS_CODE='0'";
	...
	if($mode=="up" and (!in_array("0",$SNS_TYPE) && $SNS_TYPE)){
			$spc="(";
	...
	if(!$order){
		$order=" order by BUYER_CODE desc";
	}
	...
	$que2="select count(1) from buyer where STS_CODE='0'";
	$que2.=$where;
                ...
                <table width="100%" border="0" >
                  ...
                  <thead>
                    <tr>
					  ...
					  <th scope="col">찜한상품</th>
					  <th scope="col">단골가게</th>
					  <th scope="col">SNS</th>
                    </tr>
                  </thead>
                  <tbody>
...
?>
                    ...
                    <tr>
                      ...
                      <td><?=$p->UPDATE_DATE?></td>
					  <td>0</td>
					  <td><?echo zzim_cnt_is($p->BUYER_CODE);?></td>
					  <td><?echo like_shop_cnt_is($p->BUYER_CODE);?></td>
					  <td>
							<?echo sns_is($p->SNS_TYPE);?>
					  </td>
                    </tr>
<?
$no--;
