...
?>
                              <tr id="tr<?=$p->gubun?>">
								  ...
								  <td><?=$p->away?></td>
								  <td>승(<?=$p->odds1?>)<input type="checkbox" class="chkbx" title="<?=$p->gameTitle?>" islip="<?=$p->islip?>" id="checkId[]" name="isCheck[<?=$p->islip?>]" value="1"></td>
								  <td><?if($p->odds2>0){?>무(<?=$p->odds2?>)<input type="checkbox" class="chkbx" title="<?=$p->gameTitle?>" islip="<?=$p->islip?>" id="checkId[]" name="isCheck[<?=$p->islip?>]" value="0"><?}?></td>
								  <td>패(<?=$p->odds3?>)<input type="checkbox" class="chkbx" title="<?=$p->gameTitle?>" islip="<?=$p->islip?>" id="checkId[]" name="isCheck[<?=$p->islip?>]" value="-1"></td>
                              </tr>
<?}?>  
...
$(".chkbx").click(function() {
		...
		var cnt=$("input[id='checkId[]']:checked").length;
