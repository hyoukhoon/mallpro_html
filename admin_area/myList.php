<?php include $_SERVER['DOCUMENT_ROOT']."/admin_area/inc/admin_top.php";
	...
	$que3="select count(*) from myItem a, taobao b where a.pnum=b.num $where";
...
//exit;
	...
	$que="select *,a.uid as muid,a.regDate as rDate,a.price as myPrice from myItem a, taobao b where a.pnum=b.num $where";
	$limit_query=" order by a.num desc limit $start_page, $end_page";
	...
	font-size:16px;
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> 타오바오 내상품 목록</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel" style="padding:20px;">
                      <h4><i class="fa fa-angle-right"></i>전체 상품수 : <?echo number_format($total);?>개</h4>
...
?>
                              ...
                              <tr>
                                  <td><?=$p->muid?></td>
								  <td><?echo $p->itemName;?></td>
								  <td><?echo number_format($p->myPrice);?>원</td>
                                  <td><a href="<?echo $p->url;?>" target="_blank">링크이동</a></td>
								  <td><?=$p->rDate?></td>
