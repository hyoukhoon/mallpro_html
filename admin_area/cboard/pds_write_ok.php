			...
			for($i=0; $i<3; $i++)
				{
					if($upfile_name[$i])
					{
						...
						$upfile_file[$i]="HM".$file_name_addition."_".$i.".".$upfile_detail_name[$i];
...
$que="insert into pds values ('','$company1','$pname','$model','$upfile_name[0]','$upfile_file[0]','$gubun',now())";
//echo $que."<br>";
//exit;
...
location_is('pds_list.php','num='.$go_num.'&multi='.$multi,'');
