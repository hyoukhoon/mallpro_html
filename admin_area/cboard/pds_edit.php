...
<script type="text/javascript" src="../../se2/js/HuskyEZCreator.js" charset="utf-8"></script>
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr><td class="title">데이타 수정</td></tr>
...
<form action="pds_edit_ok.php"  method="post" name="f" enctype="multipart/form-data">
				...
				<tr>
					...
					<td class="td_02"><input type="text" name="company1" size="50" value="<?=$rs->company?>"></td>
				</tr>
				<tr>
					<td class="th_01" width="10%">제품명</td>
					<td class="td_02"><input type="text" name="pname" size="50" value="<?=$rs->pname?>"></td>
				</tr>
				<tr>
					<td class="th_01" width="10%">모델명</td>
					<td class="td_02"><input type="text" name="model" size="50" value="<?=$rs->model?>"></td>
				</tr>
				<tr>
					<td class="th_01" width="10%">기존파일</td>
					<td class="td_02"><a href="/board/data/<?=$rs->fn1?>"><?=$rs->fn_name1?></a></td>
				</tr>
				<tr>
