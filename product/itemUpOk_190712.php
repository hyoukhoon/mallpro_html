...
if(count($optMixArray)){
		$optMix=array();
		if($optionValue1 and $optionValue2){
			$i=0;
		...
		$query="update optiontable set optionValue1='$optionValue1', optionValue2='$optionValue2', optionMixPrice='$optMix' where pnum='".$rs3[0]."' and isRegist<>'1'";
		$sql = $mysqli->query($query) or die($mysqli->error);
