...
?>
<style>
#floatMenu { position:absolute; top:163px; z-index:55;width:100%;background-color:#F0F0F0; }
</style>
<script>
                ...
                <table width="100%" border="0" style="table-layout:fixed; word-break:break-all;">
                  ...
                  <thead>
                    <tr>
					  ...
					  <th scope="col">옵션<br><font color="red">※옵션과 옵션은 반드시 , 로 구분합니다<!-- <br>빼고싶은 옵션은 옵션가수정을 클릭후 해당옵션의 가격을 -1000으로 수정하십시오. --></font> 
					  </th>
                      ...
                      <td style="text-align:left;line-height:25px;">
							...
							<tr>
								<td style="width:50%;background-color:#fff;">
									<textarea name="itemName_<?=$p->num?>" id="itemName" placeholder="상품명을 입력하세요." style="width:100%;height:60px;"><?echo stripslashes($p->itemName);?></textarea>
								</td>
							</tr>
							<tr>
...
?>
						...
						<ul>
							...
							<li><span style="font-weight:bold;">판매가</span> : <input type="text" name="myPrice" id="myPrice" <?if($p->optionType==2){?>readonly alt="opt" onclick="alert('옵션가수정 버튼을 눌러 수정하세요.');"<?}?> value="<?=$p->myPrice?>" style="width:100px;text-align:right;">원</li>
