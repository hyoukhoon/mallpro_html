...
<div id="pop_wrap">
  ...
  <!-- 타이틀 S--> 
     <ul class="top_title_area" style="margin-top:0px;height:80px;">
       <li class="top_title"><?echo $rs->itemName;?></li><br>
	   <li class="top_title">동영상URL <input type="text" name="videoUrl" id="videoUrl" value="<?=$rs->videoUrl?>" size="80" style="height:25px;"></li><br>
